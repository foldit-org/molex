...
///
/// Decodes the assembly and builds each annotation column as a real
/// `numpy.ndarray`, returning them in an `AtomArrays` handle. Unlike the
/// `*_to_atom_array` functions this path imports only `numpy`, never Biotite.
///
/// # Errors
///
